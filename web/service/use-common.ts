...
export const commonQueryKeys = {
  ...
  filePreview: (fileID: string) =>
    [NAME_SPACE, 'file-preview', fileID] as const,
  ...
  defaultModel: (type: ModelTypeEnum) =>
    [NAME_SPACE, 'default-model', type] as const,
  ...
  codeBasedExtensions: (module?: string) =>
    [NAME_SPACE, 'code-based-extensions', module] as const,
  ...
  notionBinding: (code?: string | null) =>
    [NAME_SPACE, 'notion-binding', code] as const,
...
export const useOneMoreStep = () => {
  return useMutation({
    ...
    mutationFn: (body: OneMoreStepPayload) =>
      post<CommonResponse>('/account/init', { body }),
  })
}
...
export const useDataSourceIntegrates = (
  options: DataSourceIntegratesOptions = {},
) => {
