...
This document describes how the wan plugin handles your data.

### Scope

This privacy statement applies only to the wan plugin and to data
processed through its features. It does not cover any other plugins, tools,
or services you may use alongside it.

### Data We Collect

Depending on how you use the plugin, wan may process the following
categories of data:
...
calling the Wan API and returning results back to Dify.
