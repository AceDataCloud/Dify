...
This document describes how the fish plugin handles your data.

### Scope

This privacy statement applies only to the fish plugin and to data
processed through its features. It does not cover any other plugins, tools,
or services you may use alongside it.

### Data We Collect

Depending on how you use the plugin, fish may process the following
categories of data:
...
calling the Fish API and returning results back to Dify.
