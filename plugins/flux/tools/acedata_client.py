...
class AceDataFluxError(RuntimeError):
    code: str
    message: str
...
class AceDataFluxClient:
    ...
    def _post_images(self, *, payload: dict[str, Any], timeout_s: int) -> AceDataFluxImagesResult:
        ...
        return AceDataFluxImagesResult(
    ...
    def _post_json(self, *, path: str, payload: dict[str, Any], timeout_s: int) -> dict[str, Any]:
        ...
        try:
            ...
            raise AceDataFluxError(code="request_failed", message=str(e)) from e

        try:
            body = resp.json()
        except ValueError as e:
            snippet = (resp.text or "")[:500]
            raise AceDataFluxError(
                code="invalid_json",
