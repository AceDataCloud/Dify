...
This document describes how the minimax plugin handles your data.

### Scope

This privacy statement applies only to the minimax plugin and to data
processed through its features. It does not cover any other plugins, tools,
or services you may use alongside it.

### Data We Collect

Depending on how you use the plugin, minimax may process the following
categories of data:
...
minimax plugin through the official project repository or distribution
