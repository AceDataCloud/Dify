...
This document describes how the qwen_image plugin handles your data.

### Scope

This privacy statement applies only to the qwen_image plugin and to data
processed through its features. It does not cover any other plugins, tools,
or services you may use alongside it.

### Data We Collect

Depending on how you use the plugin, qwen_image may process the following
categories of data:
...
qwen_image plugin through the official project repository or distribution
