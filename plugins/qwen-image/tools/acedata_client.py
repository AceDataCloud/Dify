...
class AceDataQwenImageError(RuntimeError):
    code: str
    message: str
...
@dataclass(frozen=True)
class AceDataQwenImageImagesResult:
    task_id: str | None
    trace_id: str | None
...
class AceDataQwenImageClient:
    ...
    def generate_images(
    ...
    ) -> AceDataQwenImageImagesResult:
        body = self._post(path="/qwen-image/images", payload=payload, timeout_s=timeout_s)
        ...
        return AceDataQwenImageImagesResult(
    ...
    def _post(self, *, path: str, payload: dict[str, Any], timeout_s: int) -> dict[str, Any]:
        ...
        try:
            ...
            raise AceDataQwenImageError(code="request_failed", message=str(e)) from e
